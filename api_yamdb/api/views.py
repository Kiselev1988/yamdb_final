...
class CategotyGenreViewSet(CreateListDeleteViewSet):
    """Общая часть для вьюсетов Category и Genre"""
    filter_backends = (SearchFilter,)
    search_fields = ('=name',)
    lookup_field = 'slug'
...
class CategoryViewSet(CategotyGenreViewSet):
    """Вьюсет для модели Category."""
    queryset = Category.objects.all()
    serializer_class = CategorySerializer


class GenreViewSet(CategotyGenreViewSet):
